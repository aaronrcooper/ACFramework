...
namespace ACFramework
{
    ...
    class Sound
    {
        ...
        public static readonly int Samurai = 6;
        public static readonly int Shout = 7;
        public static readonly int WorkHard = 8;
    ...
    class ModelsMD2
    {
        ...
        public static readonly int Enemy = 4;
        ...
        private static readonly ModelsMD2Info[] minfo = {
            ...
            new ModelsMD2Info("vegeta", "veggt.pcx", 0.4f, false)
        };            
